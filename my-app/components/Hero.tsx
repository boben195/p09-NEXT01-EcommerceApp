  ...
  return (
     ...
     md:flex-row justify-center items-center bg-white px-4 md:px-12">
          <div className="max-w-2xl">
              <h1 className="text-5xl pt-6 md:pt-0 md:text-7xl leading-tight font-semibold text-black">Timeless Elegance On Your Wrist</h1>
              <p className="text-[#495057] mt-4">Discover our curated collection of premium watches,
